...
Sidebar.prototype.init = function()
{
	...
	this.addNavigationElementsPalette(true);
	this.addInteractionElementsPalette(true);
	this.addUsabilityElementsPalette(true);
};
...
/**
 * Adicionando os elementos de navegação na barra lateral
 */
 Sidebar.prototype.addNavigationElementsPalette = function(expand)
 {

 	var fns = [
	 	this.createVertexTemplateEntry('shape=ext;rounded=1;html=1;whiteSpace=wrap;verticalAlign=top;fillColor=none;fontStyle=0;fontSize=12;', 180, 90, 'Objetivo do Usuário', 'Unidade de Apresentação', null, null, 'bpmn task process'),
	 	this.createEdgeTemplateEntry('endArrow=block;endFill=1;endSize=6;html=1;', 100, 0, '', 'Navegação', null, 'USINN Navegação'),
	 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#000000;', 40, 40, '', 'Ponto de Abertura', null, null, 'Ponto de Abertura'),
	 	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;shape=endState;fillColor=#000000;html=1;aspect=fixed;', 40, 40, '', 'Ponto de Encerramento', null, null, 'Ponto de Encerramento')
 	];
 	this.addPaletteFunctions('navigationElements', mxResources.get('navigationElements'), (expand != null) ? expand : true, fns);
 };

 /**
  * Adicionando os elementos de interação na barra lateral
  */
 Sidebar.prototype.addInteractionElementsPalette = function(expand)
 {
 	var sb = this;	
 	var fns = [
 			this.addEntry('shape group container', function()
 			{
 			    var cell = new mxCell('Ação do Usuário', new mxGeometry(0, 0, 180, 90), 'html=1;whiteSpace=wrap;');
 			    cell.vertex = true;
 			    
 				var actor = new mxCell('', new mxGeometry(cell.geometry.width - 35, cell.geometry.height - 40, 30, 35), 'shape=actor;whiteSpace=wrap;html=1;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				actor.vertex = true;
 				cell.insert(actor);
 		    	
 	    		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Ação do Usuário');
 			}),
 			this.createVertexTemplateEntry('shape=ext;rounded=0;html=1;whiteSpace=wrap;fillColor=#000000;', 40, 40, '', 'Processo do Sistema', null, null, 'Processo do Sistema'),
 			this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;endArrow=block;', 100, 0, '[condição] <br> Descrição [dados]', 'Transição do Usuário', null, 'Transição do Usuário'),
 				this.addEntry('bpmn message flow', function()
 				{
 					var edge = new mxCell('conteúdo', new mxGeometry(0, 0, 0, 0), 'dashed=1;html=1;jettySize=auto;orthogonalLoop=1;verticalAlign=bottom;');
 			    	...
 			    	var cell = new mxCell('', new mxGeometry(-0.5, 0, 20, 15), 'shape=callout;whiteSpace=wrap;html=1;perimeter=calloutPerimeter;aspect=fixed;size=4;position=0.5;base=7;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 			    	cell.geometry.relative = true;
 			    	cell.vertex = true;
 			    	cell.geometry.offset = new mxPoint(-30, -20);
 			    	edge.insert(cell);

 					return sb.createEdgeTemplateFromCells([edge], 100, 0, 'Feedback do Sistema');
 				}),

 	];
 	
 	this.addPaletteFunctions('interactionElements', mxResources.get('interactionElements'), (expand != null) ? expand : true, fns);
 };

 /**
  * Adicionando os elementos de usabilidade na barra lateral
  */
 Sidebar.prototype.addUsabilityElementsPalette = function(expand)
 {
 	var sb = this;
 	...
 	var fns = [
 			this.addEntry('shape group container', function()
 			{
 			    var cell = new mxCell('Objetivo do Usuário', new mxGeometry(0, 0, 180, 90),'shape=ext;rounded=1;html=1;whiteSpace=wrap;verticalAlign=top;fillColor=none;fontStyle=0;fontSize=12;');
 			    cell.vertex = true;
 			    
 				var symbol = new mxCell('', new mxGeometry(cell.geometry.width - 35, 5, 30, 35), 'shape=mxgraph.arrows.jump-in_arrow_1;whiteSpace=wrap;html=1;fillColor=#000000;strokeColor=#000000;strokeWidth=1;direction=north;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				symbol.vertex = true;
 				cell.insert(symbol);
 		    	
 	    		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Unidade de Apresentação');
 			}),
 			this.addEntry('Ação do Usuário', function()
 			{
 			    var cell = new mxCell('Ação do Usuário', new mxGeometry(0, 0, 180, 90),'html=1;whiteSpace=wrap;');
 			    cell.vertex = true;
 			    
 				var actor = new mxCell('', new mxGeometry(cell.geometry.width - 40, cell.geometry.height - 45, 30, 35), 'shape=actor;whiteSpace=wrap;html=1;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				actor.vertex = true;
 				cell.insert(actor);

 				var symbol = new mxCell('', new mxGeometry(actor.geometry.width + 2, 0, 5, 15), 'shape=rectangle;whiteSpace=wrap;html=1;movable=0;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				symbol.vertex = true;
 				actor.insert(symbol);

 				var symbol = new mxCell('', new mxGeometry(actor.geometry.width + 2, 17, 5, 5), 'shape=rectangle;whiteSpace=wrap;html=1;movable=0;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				symbol.vertex = true;
 				actor.insert(symbol);
 		    	
 	    		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Ação do Usuário Obrigatória');
 			}),

 			this.addEntry('shape group container', function()
 			{
 			    var cell = new mxCell('Conteúdo do Alerta', new mxGeometry(0, 0, 180, 90), 'html=1;whiteSpace=wrap;');
 			    cell.vertex = true;
 			    
 				var triangle = new mxCell('', new mxGeometry(cell.geometry.width - 43, cell.geometry.height - 45, 40, 35), 'shape=triangle;whiteSpace=wrap;html=1;direction=north;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				triangle.vertex = true;
 				cell.insert(triangle);

 				var symbol = new mxCell('', new mxGeometry(triangle.geometry.width - 22, 9, 5, 15), 'shape=rectangle;whiteSpace=wrap;html=1;movable=0;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				symbol.vertex = true;
 				triangle.insert(symbol);

 				var symbol = new mxCell('', new mxGeometry(triangle.geometry.width - 22, 26, 5, 5), 'shape=rectangle;whiteSpace=wrap;html=1;movable=0;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				symbol.vertex = true;
 				triangle.insert(symbol);
 		    	
 	    		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Alerta de Notificação ou Confirmação');
 			}),

 			this.addEntry('shape group container', function()
 			{
 			    var cell = new mxCell('Indicador de Progresso', new mxGeometry(0, 0, 180, 90),'html=1;whiteSpace=wrap;');
 			    cell.vertex = true;
 			    
 				var symbol = new mxCell('', new mxGeometry(cell.geometry.width - 40, cell.geometry.height - 35, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;outlineConnect=0;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 				symbol.vertex = true;
 				cell.insert(symbol);
 		    	
 	    		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Processo do Sistema com Indicador de Progresso');
 			}),
			this.addEntry('bpmn message flow', function()
 			{
 				var edge = new mxCell('descrição', new mxGeometry(0, 0, 0, 0), 'html=1;jettySize=auto;orthogonalLoop=1;verticalAlign=bottom;');
 				edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
 				edge.geometry.setTerminalPoint(new mxPoint(100, 0), false);
 				edge.geometry.relative = true;
 				edge.edge = true;
 			    ...
 			    var cell = new mxCell('', new mxGeometry(-0.3, 0, 15, 15), 'shape=mxgraph.basic.x;whiteSpace=wrap;html=1;strokeWidth=1;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
 			    cell.geometry.relative = true;
 			    cell.vertex = true;
 			    cell.geometry.offset = new mxPoint(-30, -20);
 			    edge.insert(cell);

 				return sb.createEdgeTemplateFromCells([edge], 100, 0, 'Transição de Cancelamento');
 			}), 

 			this.addEntry('uml sequence invoke call delegation synchronous invocation activation', function()
			{

	    		var cell = new mxCell('Nome da Coleção', new mxGeometry(0, 0, 120, 100),
	    	    	'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;' +
	    	    	'resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;html=1;points=[];perimeter=orthogonalPerimeter;');
	    		cell.vertex = true;
	    		cell.insert(sb.cloneCell(field, 'dados'));
	    		cell.insert(sb.cloneCell(field, 'dados'));
	    		cell.insert(sb.cloneCell(field, 'dados'));

	    		var data1 = new mxCell('', new mxGeometry(0, 0, 18, 20), 'shape=datastore;whiteSpace=wrap;html=1;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
	    		data1.geometry.relative = true;
	    		data1.vertex = true;
	    		data1.geometry.offset = new mxPoint(-40, -25);
	    		

				var edge1 = new mxCell('dados', new mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=open;entryX=0;entryY=0;dashed=1;');
				edge1.geometry.setTerminalPoint(new mxPoint(-100, 0), true);
				...
				var data2 = new mxCell('', new mxGeometry(0, 0, 18, 20), 'shape=datastore;whiteSpace=wrap;html=1;movable=1;resizable=0;rotatable=0;deletable=0;editable=0;connectable=0;');
				data2.geometry.relative = true;
				data2.vertex = true;
				data2.geometry.offset = new mxPoint(-40, -25);
				
				var edge2 = new mxCell('dados', new mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=open;dashed=1;endSize=8;exitX=0;exitY=0.95;');
				edge2.geometry.setTerminalPoint(new mxPoint(-100, 100), false);
 	...
 	this.addPaletteFunctions('usabilityElements', mxResources.get('usabilityElements'), (expand != null) ? expand : true, fns);
 };
